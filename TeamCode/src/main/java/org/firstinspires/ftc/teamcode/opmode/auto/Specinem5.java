...
public class Specinem5 extends LinearOpMode {
    ...
    Pose2d startPose = new Pose2d(-16.8, 63, Math.toRadians(180));
    Pose2d specinem1 = new Pose2d(-11.225201464074804, 49, Math.toRadians(113));
    Pose2d specinem1_1 = new Pose2d(-12.5, 33, Math.toRadians(90));
    Pose2d specimen2 = new Pose2d(-9.5, 32, Math.toRadians(90));
    Pose2d specimen3 = new Pose2d(-8.5, 33, Math.toRadians(90));
    Pose2d specimen4 = new Pose2d(-4, 33, Math.toRadians(90));
    Pose2d specimen5 = new Pose2d(-1, 33, Math.toRadians(90));
    Pose2d specimen6 = new Pose2d(-6.5, 33,Math.toRadians(90));
    ...
    ArrayList<Pose> move1 = new ArrayList<Pose>() {
        {
            ...
            add(new Pose(new Pose2d(-36.92312886395792,13,Math.toRadians(90))));
            add(new Pose(new Pose2d(-50.5,13,Math.toRadians(90))));
            add(new Pose(new Pose2d(-51.5,51 ,Math.toRadians(90))));
        }
    };
    ArrayList<Pose> move2 = new ArrayList<Pose>() {
        {
            add(new Pose(new Pose2d(-48.82068543922244,13,Math.toRadians(90))));
            add(new Pose(new Pose2d(-59.42485563022884,13,Math.toRadians(90))));
            add(new Pose(new Pose2d(-59,51,Math.toRadians(90))));
        }
    };
    ArrayList<Pose> move3 = new ArrayList<Pose>() {
        {
            add(new Pose(new Pose2d(-57,13,Math.toRadians(90))));
            add(new Pose(new Pose2d(-64.0570250984252,13,Math.toRadians(90))));
...
//            add(new Pose(new Pose2d(-53.19720410925197,11.853723000353716,Math.toRadians(270))));
    ...
    public static Pose2d transitionPoint = new Pose2d(-13.5,42.5,Math.toRadians(110));
    ...
    void moveSample32() {
        ...
        while (robot.autoDrive.driveMode != P2Pdrive.DriveMode.IDLE && opModeIsActive() && !isStopRequested()) {
             if(robot.autoDrive.path.isLast() && !atLast) {
