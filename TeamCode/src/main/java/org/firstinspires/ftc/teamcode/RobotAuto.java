...
@Config
public class RobotAuto implements OpModeManagerNotifier.Notifications, GlobalWarningSource {
...
//                hub2.getBulkData();
    ...
    public RobotAuto(OpMode opMode, boolean isAutonomous, Pose2d startPose) {
